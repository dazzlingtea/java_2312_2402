...
class Prob7Circle implements Prob7Shape {
	...
	public void draw() {
		System.out.println(" 반지름이 "+this.radius+"인 원을 그립니다.");
	}
...
public class Assignment9
{
    public static void main(String[] args) {
        ...
        // 틀린 부분:int VERSION; protected int out(); static public void drag();
        // 이유: 상수만 사용할 수 있기 때문에 값을 지정해줌
    	//		인터페이스에서는 protected 메소드를 사용할 수 없음
    	//		static 메소드를 추상 메소드로 쓰면 오버라이딩 할 수 없음 
        ...
        // 6. 다음 중 인터페이스의 특징이 아닌 것을 고르시오. 답 (2)
