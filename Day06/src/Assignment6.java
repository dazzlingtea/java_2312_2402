...
class TV {
	...
	public void explain() {
		System.out.println(this.company + "에서 만든 "+ this.year +"년식 "+ this.inch + "인치 TV");
	}
}
...
class Grade {
	...
	public void getAverage() {
		System.out.println("평균은 " + (this.g1+this.g2+this.g3)/3);
	}
}
...
public class Assignment6
{
    public static void main(String[] args) {
       ...
       while(true) {
        ...
        // 1) public void Samp(int x) { --> void 삭제
        // 2) public void Samp() { --> void 삭제
        // 3) this(0);  --> 9번줄로 이동 
